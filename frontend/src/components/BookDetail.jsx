...
const BookDetail = ({ bookId, setBookDetail }) => {
    ...
    return (
            <Box id="book-detail-card">
                <Box id="book-detail-content" bg={useColorModeValue('gray.100', 'gray.700')}>
                ...
                <Box mt={5} id="comment-section" bg={useColorModeValue('gray.100', 'gray.700')}>
                    <Comments bookId={bookId} comments={book.comments} commentCreated={commentCreated} setCommentCreated={setCommentCreated} />
                </Box>
            </Box>
    )
};
