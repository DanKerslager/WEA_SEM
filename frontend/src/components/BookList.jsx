...
const BookList = ({ setDetail, books, loading, error }) => {
  ...
  return (
    <div id="book-list">
      {!loading && !error && books.map(book => (
          <Card onClick={() => setDetail(true)}id="book-card" borderWidth='1px' p='10px' borderRadius='lg' direction={{ base: 'column', sm: 'row' }}
